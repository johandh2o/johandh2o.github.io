...
------
We can also define the latent variables in Rubin's framework of potential outcomes, which allow us to to define directly the ITE (Individualized Treatment Effect), also knows as the CATE (Conditional Average Treatment Effect) and the ATE (Average Treatment Effect):
$$
\begin{aligned}
